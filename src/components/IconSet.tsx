...
export const DigitalAllyLogoIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    ...
    <path
      d="M12 12.5C13.3807 12.5 14.5 11.3807 14.5 10V7C14.5 5.61929 13.3807 4.5 12 4.5C10.6193 4.5 9.5 5.61929 9.5 7V10C9.5 11.3807 10.6193 12.5 12 12.5Z"
      stroke="white"
      strokeWidth="1.5"
      strokeLinecap="round"
    ...
    />
    <path
      d="M16 10V10.5C16 12.7091 14.2091 14.5 12 14.5C9.79086 14.5 8 12.7091 8 10.5V10"
      stroke="white"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const GlobeIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M10.5 21l-5.48-5.48a8.25 8.25 0 010-11.668L10.5 3m0 18a8.232 8.232 0 005.48-2.018l4.02-4.02a8.232 8.232 0 000-11.668L10.5 3m0 18h.008v.008H10.5v-.008zM10.5 3h.008v.008H10.5V3z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 21a9.004 9.004 0 008.13-5.25M3.87 15.75A9.004 9.004 0 0112 3"
    />
  </svg>
);
...
export const ArrowPathIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.18-3.185m-7.524 0h-4.992"
    />
  </svg>
);
...
export const UserGroupIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 015.968 0m-5.968 0a3.75 3.75 0 00-5.968 0m5.968 0L9 15.187m5.364-2.463a3.75 3.75 0 015.968 0m-5.968 0a3.75 3.75 0 00-5.968 0m5.968 0L9 15.187"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 9a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z"
    />
  </svg>
);
...
export const BuildingStorefrontIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M13.5 21v-7.5A2.25 2.25 0 0011.25 11.25H4.5A2.25 2.25 0 002.25 13.5V21M3 3h18M5.25 3v18m13.5-18v18M9 6.75h6.375a3.375 3.375 0 013.375 3.375v1.5a2.25 2.25 0 01-2.25 2.25H9a2.25 2.25 0 01-2.25-2.25v-1.5A3.375 3.375 0 019 6.75z"
    />
  </svg>
);
...
export const StopCircleIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9 9.563C9 9.253 9.253 9 9.563 9h4.874c.31 0 .563.253.563.563v4.874c0 .31-.253.563-.563.563H9.563A.562.562 0 019 14.437V9.564z"
    />
  </svg>
);
